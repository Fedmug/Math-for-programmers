...
откуда следует, что $1984_{10} = 7\mathrm c0_{16}$ (шестнадцатеричная система требует $16$ цифр, поэтому к стандартным цифрам $0-9$ добавляются «цифры» $a=10$, $b=11$, $c=12$, $d=13$, $e=14$, $f=15$). Наконец, для восьмеричной системы получаем
...
* абстрагирование от конкретных примеров и выработка универсальных паттернов;
